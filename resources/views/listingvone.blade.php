	...
	*************************************-->
	<nav id="menu">
		<ul>
			...
			<li><a href="destinations.html">İller</a></li>
						...
						<nav id="tg-nav" class="tg-nav">
							...
							<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
								<ul>
									...
									<li class="menu-item-has-children menu-item-has-mega-menu current-menu-item"><a href="liste">Listeler</a></li>
										<div class="mega-menu">
											<ul>
												<li class="current-menu-item"><a href="listingvone.html">list style one</a></li>
												<li><a href="listingvtwo.html">list style two</a></li>
												<li><a href="listingvthree.html">list style three</a></li>
												<li><a href="listingvfour.html">list style four</a></li>
												<li><a href="listingvfive.html">list style five</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>Tüm Turlar</h1>
							<h2>Dolu Dolu Bir Seyahat Deneyimi İçin Doğru Adrestesiniz..</h2>
							<ol class="tg-breadcrumb">
								<li><a href="tur">Anasayfa</a></li>
								<li class="tg-active">Listeler</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div id="tg-content" class="tg-content">
							<div class="tg-listing tg-listingvone">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										...
										<div class="tg-populartour">
											<figure>
												<a href="{{ route('tourdetail', ['il_ad' => $tl->il]) }}"><img src="{{ asset('uploads/' . $tl->image) }}" alt="image destinations"></a>
												<span class="tg-descount">{{$tl->indirim}}</span>
											</figure>
											<div class="tg-populartourcontent">
												<div class="tg-populartourtitle">
													<h3><a href="{{ route('tourdetail', ['il_ad' => $tl->il]) }}">{{$tl->il}}</a></h3>
												</div>
												...
												<div class="tg-populartourfoot">
													<div class="tg-durationrating">
														<span class="tg-tourduration">{{$tl->gün}}</span>
														{{-- <span class="tg-stars"><span></span></span>
														<em>(3 Review)</em> --}}
													</div>
													<div class="tg-pricearea">
														<del>{{$tl->normal_fiyat}}</del>
														<h4>{{$tl->indirimli_fiyat}}</h4>
													</div>
												</div>
								...
								{{-- <nav class="tg-pagination">
									<ul>
										<li class="tg-active"><a href="liste">1</a></li>
