					...
					<div class="tg-topbar">
						...
						<div class="tg-addnavcartsearch">
							...
							<nav class="tg-cartsearch">
								<ul>
									<li>
										<a href="shop"><img src="images/icons/icon-03.png" alt="image destinations"></a>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>Alışveriş</h1>
							<h2>Macera Başlasın: Seyahat Ürünleri Mağazası</h2>
							<ol class="tg-breadcrumb">
								<li><a href="javascript:void(0);">Ana Sayfa</a></li>
								<li class="tg-active">Alışveriş</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-product">
											<figure><a href="{{$sp->link}}"><img src="{{ asset('uploads/' . $sp->image) }}" alt="image destinations"></a></figure>
											<div class="tg-productcontent">
												<div class="tg-producttitle">
													<h3><a href="{{$sp->link}}">{{$sp->urun_adi}}</a></h3>
												</div>
