				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>Profilim</h1>
							<h2>Profilden Daha Fazlası</h2>
							<ol class="tg-breadcrumb">
								<li><a href="tur">Anasafya</a></li>
								<li class="tg-active">Profilim</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div id="tg-twocolumns" class="tg-twocolumns">
						<form class="tg-formtheme tg-formdashboard" action="{{ url('/updateProfile') }} " method="POST">
                            @csrf
									...
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												...
												<li class="selected"><a href="my-profile.html"><i class="icon-pen2"></i><span>Edit Profile</span></a></li>
												...
												<div class="tg-content">
													<fieldset>
														<div class="form-group">
															...
															<input id="name" type="text" name="name" value="{{ old('name', $user->profile->name ?? '') }}"  class="form-control" placeholder="">
														</div>
														<div class="form-group">
															<label>Last name <sup>*</sup></label>
															<input type="text" name="last_name" value="{{ old('lastname', $user->profile->lastname ?? '') }}" class="form-control" placeholder="">
														</div>
														<div class="form-group">
															<label>Email Address <sup>*</sup></label>
															<input type="email" name="mail" value="{{ old('mail', $user->mail ?? '') }}" class="form-control" placeholder="">
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<textarea name="adres" placeholder="Adresinizi giriniz"></textarea>
														</div>
														<button type="submit" class="tg-btn"><span>Kaydet</span></button>
													</fieldset>
												</div>
											</div>
										</div>
						...
						<div class="tg-tabcontent tab-content">
							<div role="tabpanel" class="tab-pane active fade in" id="home">
								<form class="tg-formtheme tg-formlogin">
									<fieldset>
										<div class="form-group">
											<label>Ad Veya E-mail <sup>*</sup></label>
										...
										<button class="tg-btn tg-btn-lg"><span>Giriş Yap</span></button>
									</fieldset>
								</form>
							</div>
							<div role="tabpanel" class="tab-pane fade" id="profile">
								<form class="tg-formtheme tg-formlogin">
									<fieldset>
										<div class="form-group">
											<label>Ad Veya E-mail <sup>*</sup></label>
											<input id="e-mail" type="text" name="e-mail" class="form-control" placeholder="E-Mail Giriniz">
										</div>
										<div class="form-group">
											<label>Şifre <sup>*</sup></label>
											<input id="sifre" type="password" name="sifre" class="form-control" placeholder="">
										</div>
										<div class="form-group">
											<label>Şifre Tekrar <sup>*</sup></label>
											<input id="sifre_tekrar" type="password" name="sifre_tekrar" class="form-control" placeholder="">
										</div>
										<div class="form-group">
											<div class="tg-checkbox">
										...
										<button class="tg-btn tg-btn-lg"><span>Profil Oluştur</span></button>
									</fieldset>
								</form>
							</div>
						</div>
