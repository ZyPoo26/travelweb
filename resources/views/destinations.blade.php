				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>Keşfet</h1>
							<h2>Sadece Tur Değil, Bir Keşif Yolculuğu Sunuyoruz..</h2>
							<ol class="tg-breadcrumb">
								<li><a href="tur">Anasayfa</a></li>
								<li class="tg-active">İller</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div id="tg-content" class="tg-content">
							<div class="tg-topdestinations">
								<div class="row">
                                    @foreach($iller as $cty)
									<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
										<div class="tg-topdestination">
											<figure>
												<a href="{{ route('tourdetail', ['il_ad' => $cty->il_ad]) }}" class="tg-btnviewall">İncele</a>
												<a href="{{ route('tourdetail', ['il_ad' => $cty->il_ad]) }}"><img src="{{ asset('uploads/' . $cty->image) }}" alt="image description"></a>
												<figcaption>
													<h2><a href="{{ route('tourdetail', ['il_ad' => $cty->il_ad]) }}">{{$cty->il_ad}}</a></h2>
													<span class="tg-totaltours">{{$cty->gün}}</span>
												</figcaption>
											</figure>
										</div>
									</div>
