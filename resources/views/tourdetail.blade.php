...
<head>
	...
	<meta name="viewport" content="wishowh=device-wishowh, initial-scale=1">
	...
	*************************************-->
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
		...
		*************************************-->
        ...
        <div class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll" data-image-src="{{ asset('uploads/' . $det->image) }}">
							...
							<div class="tg-tourbookingdetail">
								<div class="tg-bookinginfo">
										...
										<fieldset>
											<div class="form-group">
												...
												<span class="tg-select">
													<select class="selectpicker" data-live-search="true" data-wishowh="100%">
									...
									<ul class="tg-tripinfo">
										<li><span class="tg-tourduration">{{$det->gün}}</span></li>
										<li><span class="tg-tourduration tg-availabilty">{{$det->ay}}</span></li>
										<li><span class="tg-tourduration tg-location">{{$det->yer}}</span></li>
										...
										<div class="tab-content tg-themetabcontent">
											<div role="tabpanel" class="tab-pane active tg-overviewtab" id="america">
												<div class="tg-bookingdetail">
													<div class="tg-box">
														<h2>Turumuzun detaylı açıklaması</h2>
														<div class="tg-description">
															<p>{{$det->detayli_aciklama}}</p>
														</div>
													</div>
													<div class="tg-box">
														<h2>Yanınızda Olması Gerekenler</h2>
														<div class="tg-description">
															<p>{{$det->yaninizda_olmali}}</p>
